...
with st.sidebar:
    st.image("pictures/profil.png", width=150)
...
if cv:
    execute_python_file("cv.py")
else:
    # Main homepage
    banner_image = Image.open("pictures/photo.jpg")
    ...
    **Paris 2024 Olympic and Paralympic Games**, including information about athletes, medals, and the torch relay.
    ...
    with st.expander("📊 French Olympic and Paralympic Athletes data"):
        ...
        """)
        # Load the data
        file_path = "data/athlete_fr_2024.json"
        ...
        df_excel = pd.read_excel("data/medailles2024.xlsx")
    ...
    with st.expander("🔥 Torch Relay Position data"):
        ...
        """)
        file_path = "data/games_map_torch_position.xlsx"
        with open(file_path, 'r') as file:
    ...
    tab3, tab4 = st.tabs(["🏋🏻‍♀️ Olympic Athletes", "🏃🏻‍♀️ Paralympic olympic Athletes"])
